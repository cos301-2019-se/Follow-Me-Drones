...
export class DroneListComponent implements AfterViewInit {
  ...
  connectDrone(event) {
    ...
    // this.drones[index].messages.subscribe( connect => {
    //     console.log('connected !!! | in drone-list component');
    // });
