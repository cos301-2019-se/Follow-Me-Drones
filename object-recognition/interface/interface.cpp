    ...
    while(choice != 5)
    {
        ...
        switch(choice)
        {
            ...
            case 2:
		        ...
		        cmd = "./darknet detector demo cfg/animals.data cfg/animals.cfg backup/animals_last.weights data/videos/" + data + " -thresh 0.7 -json_port 8080 -prefix data/detections/img -out_filename data/videos/output/res.mkv";
                cout << cmd << endl;
