...
class DetectionController():
    ...
    def tempRandomFilter(self, detection):
        ...
        if rand >= 95:
            print('sent detection')
            return detection
        else:
            raise DetectionException('Notification Already Sent!')


    def filter(self):
        pass
        # # Server will only check first detection and then each 50th frame thereafter
        # if abs(self.detection['frame_id'] - lastDetectedFrame) > 50 or lastDetectedFrame == 0:
        ...
        #     if abs(self.detection['frame_id'] - lastDetectedFrame) > 100:
        #         previousDetections = []

        #     lastDetectedFrame = self.detection['frame_id']
        ...
        #     animalCounters = {}
        #     for detectedAnimal in self.detection['objects']:
        ...
        #                 print('\tFrame ->', self.detection['frame_id'])
        #                 print('\tMultiple ->', detectedAnimal, '\n')

        #                 alertAppOfDetection(self.detection['frame_id'], 'multiple ' + detectedAnimal + ' detected')
        ...
        #                 alertAppOfDetection(self.detection['frame_id'], detectedAnimal)
