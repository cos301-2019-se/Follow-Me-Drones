...
class Video(DetectionStrategy):
    ...
    def startDetection(self):
        ...
        darknet = shlex.split('./darknet detector demo ' + self.config.data + ' ' + self.config.cfg + ' ' + self.config.weights + ' ' + self.config.video  + ' -thresh 0.85 -json_port 42069 -prefix ../../detections/' + self.session_time + '/img -out_filename ../../output.mkv')# -dont_show')
