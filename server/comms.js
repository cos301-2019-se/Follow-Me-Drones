    ...
    */
    ...
    socket.on('arm', function() {
        ...
        try
        {
            ...
            runningCommand = commandLine.exec('./darknet detector demo cfg/animals.data cfg/animals.cfg backup/animals_last.weights -c 2 -thresh 0.7 -json_port 8080 -out_filename data/videos/output/res.mkv > /dev/null');
